package com.yingyinqi.jasperreport.controller;

import com.itextpdf.text.pdf.PdfReader;
import com.itextpdf.text.pdf.PdfStamper;
import com.itextpdf.text.pdf.PdfWriter;
import com.yingyinqi.jasperreport.enums.FormatSuffixEnum;
import com.yingyinqi.jasperreport.handler.JasperContext;
...
public class JasperReportController {
    ...
    public void previewPrint(@PathVariable("reportName") final String reportName,
        ...
        ClassPathResource resource = new ClassPathResource("data" + File.separator + reportName + ".jasper");
